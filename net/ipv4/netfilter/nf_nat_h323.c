...
static int __init init(void)
{
	...
	rcu_assign_pointer_true(set_h245_addr_hook, set_h245_addr);
	rcu_assign_pointer_true(set_h225_addr_hook, set_h225_addr);
	rcu_assign_pointer_true(set_sig_addr_hook, set_sig_addr);
	rcu_assign_pointer_true(set_ras_addr_hook, set_ras_addr);
	rcu_assign_pointer_true(nat_rtp_rtcp_hook, nat_rtp_rtcp);
	rcu_assign_pointer_true(nat_t120_hook, nat_t120);
	rcu_assign_pointer_true(nat_h245_hook, nat_h245);
	rcu_assign_pointer_true(nat_callforwarding_hook, nat_callforwarding);
	rcu_assign_pointer_true(nat_q931_hook, nat_q931);
	return 0;
}
