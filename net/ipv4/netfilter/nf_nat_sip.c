...
static int __init nf_nat_sip_init(void)
{
	...
	rcu_assign_pointer_true(nf_nat_sip_hook, ip_nat_sip);
	rcu_assign_pointer_true(nf_nat_sip_expect_hook, ip_nat_sip_expect);
	rcu_assign_pointer_true(nf_nat_sdp_addr_hook, ip_nat_sdp_addr);
	rcu_assign_pointer_true(nf_nat_sdp_port_hook, ip_nat_sdp_port);
	rcu_assign_pointer_true(nf_nat_sdp_session_hook, ip_nat_sdp_session);
	rcu_assign_pointer_true(nf_nat_sdp_media_hook, ip_nat_sdp_media);
	return 0;
}
